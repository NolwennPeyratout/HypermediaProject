            ...
            <main>
                ...
                <div id="home-areas-container">
                    ...
                    <div id="areas-circles-container">
                        ...
                        <HomeCircleComponent class="areas-circles" :title = "'Food'" :link = "'/areas/Food'" :imgUrl="'Food_area/Food1.jpg'" />
                        <HomeCircleComponent class="areas-circles" :title = "'IT'" :link = "'/areas/IT'" :imgUrl="'IT_area/IT1.jpg'" />
                        <HomeCircleComponent class="areas-circles" :title = "'Health'" :link = "'/areas/Health'" :imgUrl="'Health_area/Health1.jpg'" />
                    </div>
                </div>
