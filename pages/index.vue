            ...
            <main>
                ...
                <div id="home-areas-container">
                    ...
                    <div id="areas-circles-container">
                        ...
                        <HomeCircleComponent class="areas-circles" :title = "'Food'" :link = "'/areas/Food'" :img-url="'~/assets/img/IT_area/Food1.jpg'" />
                        <HomeCircleComponent class="areas-circles" :title = "'IT'" :link = "'/areas/IT'" :img-url="'~/assets/img/IT_area/IT1.jpg'" />
                        <HomeCircleComponent class="areas-circles" :title = "'Health'" :link = "'/areas/Health'" :img-url="'~/assets/img/IT_area/Health1.jpg'" />
                    </div>
                </div>
